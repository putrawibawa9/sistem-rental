...
class Mobil extends Kendaraan{
    ...
    public function __construct($v_id_kendaraan, $v_nama_kendaraan, $v_tahun_kendaraan, $v_jenis, $v_foto){
        parent::__construct($v_id_kendaraan,$v_nama_kendaraan, $v_tahun_kendaraan, $v_jenis, $v_foto);
        $this->jenis = $v_jenis;
    }
