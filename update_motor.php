...
<header>
        <nav class="navbar sticky-top navbar-expand-lg bg-primary shadow">
            <h1 class="navbar-brand">Update Data Motor</h1>
        </nav>
    </header>
<main>
    <a href="tampil_motor.php"><button class="btn btn-secondary btn-lg">Kembali</button></a> 
    <div class="container">
    <div class="mb-3">
    <div class="container">
    <div class="row">
    ...
    <form action="proses.php" method="POST">
        ...
        <br>
        <button type="submit" class="btn btn-secondary btn-lg" name="updateMotor">Simpan</button>
    </form>
    </div>
    </div>
</div>
