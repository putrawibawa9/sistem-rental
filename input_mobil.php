...
<body>
    ...
    <main>
            ...
            <h1 class="navbar-brand">Input Data Mobil</h1>
            <a href="tampil_mobil.php"><button type="button" class="btn btn-secondary btn-lg">Kembali</button></a>
            <div class="mb-3">
            <div class="container">
            <div class="row">
            <div class="col-sm-5 col-md-6">
                <form action="proses.php" method="POST" enctype="multipart/form-data">
                    ...
                    <select class="form-select" type="text" name="jenis">
                    ...
                    <br>
                    <button type="submit" class="btn btn-secondary btn-lg" name="simpanMobil">Simpan</button>
                </form>
            </div>
            </div>
            </form>
